...
// Note: the Issue #92 fix #15 describe (Cmd+S in web mode does NOT trigger Tauri saveCurrent)
// was removed in remove-tauri-legacy — Tauri imports and the isTauri gate no longer exist.
